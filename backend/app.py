...
def telegram_draw_endpoint():
    ...
    PRESETS = {
        ...
        # HiDream / SDXL family
        # HiDream / SDXL family — sharper with Euler a or 2S a Karras
        "hidream_fast":      {"sampler": "Euler a",             "steps": 24, "cfg": 7.5, "w": 512, "h": 512},
        "hidream_balanced":  {"sampler": "DPM++ 2S a Karras",  "steps": 28, "cfg": 7.5, "w": 640, "h": 512},
        "hidream_photoreal": {"sampler": "DPM++ 2S a Karras",  "steps": 32, "cfg": 7.0, "w": 896, "h": 640},
